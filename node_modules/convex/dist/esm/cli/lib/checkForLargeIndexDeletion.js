...
function formatDeletedIndex(componentDefinitionPath, index, indexDiff, documentsCount) {
  const componentNameFormatted = componentDefinitionPath !== "" ? `${chalk.gray(componentDefinitionPath)}:` : "";
  const documentsCountFormatted = documentsCount >= MIN_DOCUMENTS_FOR_INDEX_DELETE_WARNING ? `  ${chalk.yellowBright(`\u26A0\uFE0F  ${documentsCount.toLocaleString()} documents`)}` : `  ${documentsCount.toLocaleString()} ${documentsCount === 1 ? "document" : "documents"}`;
